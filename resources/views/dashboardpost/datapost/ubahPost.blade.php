...
<head>
    ...
    <title>Form Ubah Post</title>
</head>
<body>
    <div class="container">
        <div class="card">
            <div class="card-body">
                <form action="/post/ubahpost/{{ $post->id_post }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="content" name="content" required value="{{ old("content", $post->content) }}">
                    </div>
                    <div class="mb-3">
